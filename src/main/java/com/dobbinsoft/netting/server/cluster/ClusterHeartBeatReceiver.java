...
//
//    @Inject
//    private ClusterHeartBeatHandler clusterHeartBeatHandler;
//
...
//                    .handler(clusterHeartBeatHandler);
//
//            b.bind(PropertyUtils.getPropertyInt("server.cluster.port"))
//                    .sync().channel().closeFuture().await();
//            log.info("[ClusterHeartBeat] shutdown!");
//        }catch (Exception e) {
//            log.error("[ClusterHeartBeat] 异常", e);
//            System.exit(0);
//        } finally {
...
//    public static class ClusterHeartBeatHandler extends SimpleChannelInboundHandler<DatagramPacket> {
//
//        @Inject
